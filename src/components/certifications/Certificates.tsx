...
const Certifications = () => {
  ...
  return (
    <section ref={ref} id="#certifications">
      ...
      <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:mx-6"
        initial="hidden"
      ...
      {isModalOpen && selectedImage && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50" onClick={closeModal}>
          <div className="relative bg-white p-4 rounded-lg">
            ...
            <Image src={selectedImage} alt="Selected"   height={1920} width={1080} className="max-w-[90%] max-h-[80vh] object-contain" />
          </div>
        </div>
      )}
    </section>
