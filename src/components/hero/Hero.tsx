...
const Hero = () => {
    return (
        <header className="flex relative w-full h-[75vh] items-center" id="#about">
            ...
            />
            <div className="mx-auto flex items-center flex-col gap-6 text-center max-w-[70vw]">
                ...
                <motion.button
                    ...
                    whileHover={{
                        scale: 1.1, // Scales the button on hover
                        boxShadow: "0 0 15px rgba(255, 255, 255, 0.6)", // White glow on hover
                        transition: { duration: 0.3 } // Smooth transition
                    }}
                    whileTap={{
                        scale: 0.95, // Button slightly shrinks on click
                        transition: { duration: 0.1 } // Quick tap effect
                    }}
                    onClick={
                        () => window.open("https://drive.google.com/file/d/1DCCeUaJFuhpzPTliAk69ov9zfXNphHn2/view", "_blank")
                    }
                >
                    View my resume
                </motion.button>
