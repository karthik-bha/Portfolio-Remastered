// Define a TypeScript type for skill objects
...
export const skills: Skill[] = [
    ...
    { name: 'Next.js', icon: '/svgs/skills/next.svg' },
    { name: 'Node.js', icon: '/svgs/skills/node.svg' },
    ...
    { name: 'Auth', icon: '/svgs/skills/auth.svg' },
];
